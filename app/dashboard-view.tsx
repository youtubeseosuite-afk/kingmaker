"use client";
// Path: app/dashboard-view.tsx | Type: NEW
...
export default function DashboardView({ email }: { email: string }) {
    ...
    <div className="dashboard">
      <header className="topbar">
        ...
        <div className="realm-badge">
          ...
          <div>
            <div className="realm-badge__role">{email}</div>
            <form action={logout}>
              <button className="btn" type="submit">Log ud</button>
            </form>
          </div>
        </div>
      </header>
